...
<head>
<meta charset="UTF-8">
<title>the Init about Corrections</title>
<style>
#header {
...
<body>
	...
	<div id="main">
		...
		<a href="https://www.baidu.com/"><span style="float:right;padding-right:50px">详情统计</span></a>
		</p>
		<span style="float:left;padding-left:50px;font-size:17px">创建时间:</span>
		<span style="float:left;padding-left:50px;font-size:17px">发送给:</span>
		<span style="float:left;padding-left:50px;font-size:17px">已交:</span>
		<a href="http://localhost:8080/Practice/Corrections/NoDoWork.jsp"><span style="float:right;padding-right:50px;font-size:17px">未提交作业人员</span></a>
	</div>
	<div id="control">
		<p align="center">
		<input type="button" value="批量打分"/>&nbsp;&nbsp;&nbsp;
		<input type="button" value="批量打回"/>&nbsp;&nbsp;&nbsp;
		<input type="button" value="导入成绩"/>&nbsp;&nbsp;&nbsp;
		<input type="button" value="导出成绩"/>&nbsp;&nbsp;&nbsp;
		</p>
	</div>
